      ...
      <div className="shrink-0 fade-up">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1">Hybrid RAG query engine · Groq Llama-3.3-70b-versatile</p>
          </div>
          <div className="flex items-center gap-2 flex-wrap justify-end">
            <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-purple-500/[0.06] border border-purple-500/15">
              ...
              <span className="text-[10px] font-mono text-purple-400">Llama 3.3 70B</span>
            </div>
